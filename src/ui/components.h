...
ComponentResult component_timestamped_lyrics(const Model *model, k_Rect region, DrawBuffer *buf, DirtyFlags dirty);
...
ComponentResult component_help(const Model *model, k_Rect region, DrawBuffer *buf, DirtyFlags dirty);
