...
- Added mini-controls. The idea here is that you will be able to do all the basic operations and will be able to sit a whole session of listening to music, without ever using a keyboard.
