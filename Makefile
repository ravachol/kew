...
LIBS = -L/usr/lib -lfreeimage -latomic -lpthread -lrt -pthread -lm -L/usr/lib -lglib-2.0  $(shell $(PKG_CONFIG) --libs gio-2.0 chafa libavformat fftw3f opus opusfile vorbis vorbisfile)
